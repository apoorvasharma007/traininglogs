...
from workflow import SessionWorkflowService
...
def main() -> int:
    ...
    try:
        ...
        # Existing domain services and agent
        ...
        # New modular architecture services
        ...
        input_parsing_service = InputParsingService(
            str(settings.OUTPUT_DIR / "nlu_learning.json"),
        ...
        response_service = ConversationResponseService(
            conversational_ai_service=conversational_ai_service
        )
        ...
        local_db_repository = DatabaseRepository(repo)
        json_export_service = JsonExportService(SessionExporter())
        ...
        workflow = SessionWorkflowService(
            ...
            exercise_entry_service=exercise_entry_service,
            history_guidance_service=history_guidance_service,
            input_parsing_service=input_parsing_service,
        ...
        prompts.show_info(llm_interpreter_service.status_message())
        return workflow.run()
