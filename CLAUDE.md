...
traininglogs log inputs/programs/bodybuilding_transformation_system/phase_3/week_11/push_hypertrophy_foundation_block.md

# Process all sessions in a week directory
traininglogs log inputs/programs/bodybuilding_transformation_system/phase_3/week_11/

# Process a week by program/phase/week flags
traininglogs log --program bodybuilding_transformation_system --phase 3 --week 11

# Process, commit, and publish dashboard to website
traininglogs log --program bodybuilding_transformation_system --phase 3 --week 11 --publish

# Validate a file without writing to DB
traininglogs validate inputs/programs/bodybuilding_transformation_system/phase_3/week_11/push_hypertrophy_foundation_block.md

# Other flags (work with any invocation form above)
traininglogs log <target> --dry-run     # preview without changes
traininglogs log <target> --no-commit   # process only, skip git
traininglogs log <target> --pr          # open a PR after commit
```
