...
**Goal:** 22.5 kg x 2 sets x 8-10 reps
**Rest:** 3 min 
### Warmup

### Warmup Notes
Don’t use heavy weights preserve strength for working sets and avoid injury risk
0 x feel - around the world arms extended time under tension is good enough resistance. 
2.5  x feel - around the world, lift ass off the bench or let the shoulders drop to extreme range of motion under load, keep breathing, rep count feeling based. 
 12.5 x  feel - unilateral with rotation, massage the shoulder ball and socket joint by rotating elbows all around at bottom position, rep count feeling based. 
